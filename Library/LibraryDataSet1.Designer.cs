    ...
    public partial class BookTypeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[BookType] ([bookType]) VALUES (@bookType);\r\nSELECT bTypeId, bo" +
                "okType FROM BookType WHERE (bTypeId = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[BookType] SET [bookType] = @bookType WHERE (([bTypeId] = @Original_" +
                "bTypeId) AND ((@IsNull_bookType = 1 AND [bookType] IS NULL) OR ([bookType] = @Or" +
                "iginal_bookType)));\r\nSELECT bTypeId, bookType FROM BookType WHERE (bTypeId = @bT" +
                "ypeId)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT bTypeId, bookType FROM dbo.BookType";
